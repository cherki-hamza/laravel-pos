            ...
            <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="first_name" class="form-control @error('first_name') is-invalid  @enderror" id="" placeholder="@lang('words.first_name')" value="{{ old('first_name') }}">
                  @error('first_name')
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="last_name" class="form-control @error('last_name') is-invalid  @enderror" id="" placeholder="@lang('words.last_name')" value="{{ old('last_name') }}">
                  @error('last_name')
                  <div class="alert alert-danger mt-2">
                      {{$message}}
                  </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid  @enderror" id="" placeholder="@lang('words.email')" value="{{ old('email') }}">
                    @error('email')
                    <div class="alert alert-danger mt-2">
                        {{$message}}
                    </div>
                 ...
                 <div class="row">
                    ...
                    <div style="text-align: -webkit-center;" class="col-lg-6 col-md-6 col-sm-12">
                        <h2>Default Image</h2>
                         <img class="image-preview" style="width: 20%;height: 20%;border-radius: 100%;text-align: center" src="{{ asset('public/assets/backend/images/users/default.png') }}" alt="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="">@lang('words.password')</label>
                    <input type="password" name="password" class="form-control @error('password') is-invalid   @enderror" required autocomplete="new-password" placeholder="@lang('words.password')">
                    @error('password')
                    <div class="alert alert-danger mt-2">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    <label for="the_pass">@lang('words.password_confirm')</label>
                    <input type="password" class="form-control @error('password') is-invalid   @enderror" name="password_confirmation" required autocomplete="new-password" placeholder="@lang('words.password_confirm')">
                    @error('password')
                    <div class="alert alert-danger mt-2">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        @foreach ($maps as $map)
                        <label style="margin-right: 20px;"><input type="checkbox" name="permissions[]" value="{{ $map }}_{{ $model }}" id="">@lang('words.'.$map)</label>
                        @endforeach
