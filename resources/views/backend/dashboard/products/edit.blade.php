         ...
         <div style="width: 80%;margin: 5% auto" class="box box-primary">
            ...
            <form action="{{ route('products.update' , $product->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group @error($locale.'.name') has-error  @enderror">
                    <label for="name">@lang('words.' .$locale. '.PNAME')</label>
                    <input style="margin: auto"  type="text" name="{{ $locale }}[name]" class="form-control" id="inputError" placeholder="@lang('words.'.$locale.'.P_NAME')" value="{{ $product->translate($locale)->name }}">
                    @error($locale.'.name')
                    <div class="mt-2">
                ...
                <div class="form-group @error($locale.'.description') has-error  @enderror">
                    ...
                    <textarea  name="{{ $locale }}[description]" class="form-control ckeditor" id="editor1">{{ $product->translate($locale)->description }}</textarea>
                ...
                <!-- start product image -->
                 <div class="row">
                    ...
                    <div style="text-align: -webkit-center;" class="col-lg-6 col-md-6 col-sm-12">
                        <h2>Default Image</h2>
                         <img class="image-preview" style="width: 20%;height: 20%;border-radius: 100%;text-align: center" src="{{ $product->image_path() }}" alt="">
                         @error('image')
                 ...
                 <!-- start last section -->
                 <div  style="margin-top: 40px;" class="row my-5">
                  <div class="col-md-4">
                     <!--  -->
                <div class="form-group">
                    <label for="purchase_price">@lang('words.purchase_price')</label>
                    <input style="margin: auto"  type="number" name="purchase_price" class="form-control" value="{{ $product->purchase_price }}">
                ...
                <!--  -->
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input style="margin: auto"  type="number" name="sale_price" class="form-control" value="{{ $product->sale_price }}">
                        @error('sale_price')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input style="margin: auto"  type="number" name="stock" class="form-control" value="{{ $product->stock }}">
                        @error('stock')
